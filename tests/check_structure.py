...
Derived from TRMNL_X_Start/tests/check_structure.py — guards the verified
"layout layout--col > .x-canvas" structure (no own .screen/.view, no pixel
heights / viewport hacks) so we don't regress into the height-collapse bug.
"""
